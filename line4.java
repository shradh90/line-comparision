package line;
/* using compare to method and eqals method check lines are equal or greater than or less than of two lines based on end points , so that i know when 2 lines are eual
	 ...
	 public static void calculateLength() {
		 // give inputs to the co-ordinates
	       ...
	       if(l1 == l2) {
	    	   ...
	    	   System.out.println("lenth 1 is not equal to length 2 "); 
	       }
	        ...
	        if(line1.compareTo(line2) == 0) {
	        	 ...
	        	 System.out.println("length of line l1 is less than l2 ");
	        } else  if(line1.compareTo(line2) > 0) {
